...
export default function AdminDashboard() {
  ...
  const fetchData = async () => {
    try {
      const [appRes, statsRes] = await Promise.all([
        // FIXED: Changed from adminAPI.getApplications() to adminAPI.getApplications()
        adminAPI.getApplications(),
        // FIXED: Changed from adminAPI.getDashboardStats() to adminAPI.getDashboardStats()
  ...
  const handleApprove = async () => {
    try {
      // FIXED: Changed from adminAPI.updateStatus() to adminAPI.updateStatus()
